...
class AgencesControllerTest < ActionController::TestCase
  ...
  test "should create agence" do
    assert_difference('Agence.count') do
      post :create, agence: { name: @agence.name, principalgroupe_id: @agence.principalgroupe_id, sousgroupe_id: @agence.sousgroupe_id }
    end
  ...
  test "should update agence" do
    patch :update, id: @agence, agence: { name: @agence.name, principalgroupe_id: @agence.principalgroupe_id, sousgroupe_id: @agence.sousgroupe_id }
    assert_redirected_to agence_path(assigns(:agence))
  end
